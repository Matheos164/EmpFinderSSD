      ...
      if($location == "John"){
            ...
            if($floor == 2){
                  $map = '<div id="floorplan" class="edit_cont my-3 container-fluid pb-3 ">
                        ...
                        <div id="floorplan" class="edit_cont my-3 container-fluid pb-3 ">
                              <img src="john\SubStation-2nd.png" alt="FloorMap" id="FloorMap" class="">
                        </div>';
            }elseif($floor == 3){
                  $map = '<div id="floorplan" class="edit_cont my-3 container-fluid pb-3 ">
                        ...
                        <div id="floorplan" class="edit_cont my-3 container-fluid pb-3 ">
                              <img src="john\SubStation-3rd.png" alt="FloorMap" id="FloorMap" class="">
                        </div>';
            }elseif($floor == 4){
                  $map = '<div id="floorplan" class="edit_cont my-3 container-fluid pb-3 ">
    ...
    <Header>
      <nav class="navbar navbar-expand-lg bg-body-white mt-1">
            <div class="px-3 container-fluid" style="width: 340px;">
                  <a href="main.php"><img id="logo" src="pics/logo.png" alt="Logo" width="125" height="125" ></a>
            </div>
...
<!---------------Footer----------------->
    ...
    <footer>
            <div id="links">           
                  <nav id="block-footer" class="navbar navbar-expand-lg bg-body-white mx-auto">     
                        <div class="container-fluid">
                              <ul class="navbar-nav mx-auto">
                                    <li class="nav-item">
                                          <a href="https://alectrautilities.com/conditions-service" title="Conditions of Service" class="nav-link">Conditions of Service</a>
                                    </li>
                                    <li class="nav-item">
                                          <a href="https://alectrautilities.com/vaccine-policy" title="Vaccine Policy" class="nav-link">Vaccine Policy</a>
                                    </li>
                                    <li class="nav-item">
                                          <a href="https://alectrautilities.com/privacy-policy" title="Privacy Policy" class="nav-link">Privacy Policy</a>
                                    </li>
                                    <li class="nav-item">
                                          <a href="https://alectrautilities.com/terms-use" title="Terms of Use" class="nav-link">Terms of Use</a>
                                    </li>
                                    <li class="nav-item">
                                          <a href="https://alectrautilities.com/accessibility" title="Accessibility" class="nav-link">Accessibility</a>
                                    </li>
                                    <li class="nav-item">
                                          <a href="https://alectrautilities.com/sitemap" title="Sitemap" class="nav-link">Sitemap</a>
                                    </li>
                              </ul>
                        </div>    
            ...
            <div id="copyright">
                  <span>Created by Co-op Student Matheos Amanuel</span>
                  <br>
                  <span>From Mohawk College</span>
                  <br>
                  <span>For use by Alectra Utilities </span>
            </div>
