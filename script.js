...
function showPictures(){
    ...
    switch(location){
        case 'john':
            //console.log('john');
            if(floor == 2){
                imageContainer.innerHTML = '<img src="john/john-2nd.png" alt="FloorMap" id="FloorMap" class=""><br><img src="john/SubStation-2nd.png" alt="FloorMap" id="FloorMap" class="">';
                imageContainer.style.display = 'block';
            }else if(floor == 3){
                imageContainer.innerHTML = '<img src="john/John-3rd.png" alt="FloorMap" id="FloorMap" class=""><br><img src="john/SubStation-3rd.png" alt="FloorMap" id="FloorMap" class="">';
                imageContainer.style.display = 'block';
            }else if(floor == 4){
